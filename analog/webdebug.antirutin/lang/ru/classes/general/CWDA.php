...
$MESS['WDA_HAS_OFFERS'] = 'Имеет торговые предложения';
...
$MESS['WDA_DATE_TODAY'] = 'Сегодня';
$MESS['WDA_DATE_YESTERDAY'] = 'Вчера';
$MESS['WDA_DATE_THIS_WEEK'] = 'Текущая неделя';
$MESS['WDA_DATE_THIS_MONTH'] = 'Текущий месяц';
$MESS['WDA_DATE_THIS_YEAR'] = 'Текущий год';

$MESS['WDA_GROUP_GENERAL'] = 'Общее';
$MESS['WDA_GROUP_CATALOG'] = 'Торговый каталог (цены, остатки и др)';
...
$MESS['WDA_CATALOG_STORE_AMOUNT'] = 'Остаток на складе «#NAME#»';

// Email
$MESS['WDA_EVENT_TYPE_NAME'] = 'Уведомление об уcпешном завершении (из планировщика Cron)';
$MESS['WDA_EVENT_TYPE_DESCRIPTION'] = '';
$MESS['WDA_EVENT_MESSAGE_SUBJECT'] = '#SERVER_NAME#: Модуль «Антирутин» выполнил назначенное задание.';
$MESS['WDA_EVENT_MESSAGE_BODY'] = 'Информационное сообщение сайта #SITE_NAME#
------------------------------------------

Модуль «Антирутин» успешно выполнил назначенное задание «#PROFILE_NAME#» (профиль ##PROFILE_ID#) на сайте «#SITE_NAME#» (#SERVER_NAME#).

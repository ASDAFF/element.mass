...
$MESS[$strLang.'MULTIPLE_MODE'] = 'Режим копирования множественного в немножественное';
	$MESS[$strHint.'MULTIPLE_MODE'] = 'Выберите, как следует поступать при копировании множественного значения в немножественное.<br/><br/>
	При копировании значений в поля и свойства типа «Файл» поддерживаются только режима «Выбрать только первое» и «Выбрать только последнее».';
...
$MESS[$strLang.'FILE_CONVERT_NAME'] = 'Конвертировать имя файла из имени элемента';
	...
	$MESS[$strHint.'FILE_CONVERT_NAME'] = 'Отметьте опцию, если необходимо генерировать имя файла из имени текущего элемента.<br/><br/>'.$MESS[$strLang.'FILE_CONVERT_NAME_WARNING'];

$MESS[$strLang.'COPY_RAW_ELEMENT_ID'] = 'Копировать непосредственно как ID элемента, без преобразований';
	$MESS[$strHint.'COPY_RAW_ELEMENT_ID'] = 'Опция позволяет в свойства на основе привязки (E, E:EList, E:SKU  др) копировать числовые значения, являющиеся идентификаторами элементов. Если галочка снята, копирование в такое свойство будет создавать новый элемент с соответствующим названием.';

...
Если это поле заполнено, то в файл будут логироваться полные ссылки. Без указания ссылки выгружаются относительными (напр., /catalog/product1.html или /upload/iblock/abc/abc123.jpg).';

...
$intWidth = 1000;
$intHeight = 600;
$strUrl = sprintf('/bitrix/admin/iblock_section_search.php?lang=%s&IBLOCK_ID=%d&n=%s&k=%s&iblockfix=%s&tableId=%s',
...
elseif(\Bitrix\Main\Loader::includeModule('iblock')){
	...
	$resSection = \CIBlockSection::getList([], $arFilter, false, ['NAME']);

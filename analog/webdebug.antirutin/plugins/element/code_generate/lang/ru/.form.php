...
$MESS[$strLang.'FIELD'] = 'Поле/свойство';
	$MESS[$strHint.'FIELD'] = 'Выберите поле/свойство, из которого будет взят текст, который и будет использован для генерации символьного кода. Обычно используется название элемента.';
...
$MESS[$strLang.'EXISTS_ACTION'] = 'Действие в случае неуникальности кода';
	$MESS[$strHint.'EXISTS_ACTION'] = 'Выберите, как требуется поступить если сгенерированный код уже занят.';
		...
		$MESS[$strLang.'EXISTS_ACTION_ADD_ID_ELEMENT'] = 'Добавить ID элемента';

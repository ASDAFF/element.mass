...
<ul>
	<li>код должен вернуть либо <code><b>true</b></code> (обработка раздела успешно завершена) либо <code><b>false</b></code> (при выполнении произошла ошибка, при этом текст ошибки можно задать через <nobr><code><b>$this->setError('Error text')</b></code></nobr>),</li>
	<li>код выполняется в контексте класса плагина (<code><b>PluginSection</b></code>, наследован от <code><b>Plugin</b></code>), поэтому доступна переменная <code><b>$this</b></code>, являющаяся объектом текущего плагина,</li>
